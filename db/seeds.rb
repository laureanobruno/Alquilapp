...
vehiculo.imagen.attach(io: File.open('app/assets/images/car_images/Ferrari.png'), filename: 'Ferrari.png', content_type: 'image/png')
...
vehiculo.imagen.attach(io: File.open('app/assets/images/car_images/McLarenP1.png'), filename: 'McLarenP1.png', content_type: 'image/png')
...
vehiculo.imagen.attach(io: File.open('app/assets/images/car_images/SanderoRoja.png'), filename: 'SanderoRoja.png', content_type: 'image/png')
...
vehiculo.imagen.attach(io: File.open('app/assets/images/car_images/Golf.png'), filename: 'Golf.png', content_type: 'image/png')
...
vehiculo.imagen.attach(io: File.open('app/assets/images/car_images/Clio.png'), filename: 'Clio.png', content_type: 'image/png')
...
vehiculo.imagen.attach(io: File.open('app/assets/images/car_images/Megane.png'), filename: 'Megane.png', content_type: 'image/png')
...
for i in 1..600
    ...
    d = Faker::Date.between(from: '2022-12-12', to: '2024-1-31')
...
for i in 1..100
    ...
    r.fecha_reporte = Faker::Date.between(from: '2022-12-12', to: '2024-1-31')
